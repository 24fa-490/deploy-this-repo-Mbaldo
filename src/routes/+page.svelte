...
<p>Step 3: Modify entries to the database</p>
<span class="note">(allows you to insert or remove a new container entry into the database)</span>
<br/>
<button on:click={() => {goto('/fromDBandADD')}}>Modify Database</button>
